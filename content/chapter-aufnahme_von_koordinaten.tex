...
In den \cref{fig:xylesen} auf \cpageref{fig:xylesen} wird dieser Lösungsansatz veranschaulicht.
...
\begin{figure}[ht!]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includesvg[inkscapelatex=false,width=\textwidth]{fig/versuchsaufbau_copy.svg}
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includesvg[inkscapelatex=false,width=\textwidth]{fig/sch_read_y.svg}
...
\begin{figure}[ht!]
    \centering
    \includesvg[width=\textwidth]{fig/versuchsaufbau_copy.svg}
